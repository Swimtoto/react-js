...
class App extends Component {
    ...
    fetchWeather = async ( event ) => {
        ...
        /* ASYNC - AWAIT DOCUMENTATION : https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Op%C3%A9rateurs/await */
            ...
            var option = {
              headers: {'X-Auth-Token': ' SXPXfC74bFcx0aEKS9C4YRXz1LsTLoRp5FFfHvck'},
              url: 'https://api.nasa.gov/planetary/earth/imagery?lon=100.75&lat=1.5&date=2014-02-01&cloud_score=True&api_key=SXPXfC74bFcx0aEKS9C4YRXz1LsTLoRp5FFfHvck',
              dataType: 'jason',
              type: 'get',
            };
